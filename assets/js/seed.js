...
window.SEED_DATA = {
  ...
  users: [
    ...
    { id: 'u4',  name: 'Necessary Group I/C', rank: 'SSS',    role: 'group_incharge_necessary', designation: 'Necessary Group Incharge', email: 'ng.ic@navy.mil.in',   sections: ['sec_dry', 'sec_dal', 'sec_masala'] },
    { id: 'u5',  name: 'OICBG',              rank: 'LtCdr',  role: 'reviewer',                 designation: 'OICBG',                   email: 'oicbg@navy.mil.in',   sections: ['*'] },
    { id: 'u6',  name: 'Basic Group I/C',    rank: 'SS',     role: 'group_incharge_basic',     designation: 'Basic Group Incharge',    email: 'bg.ic@navy.mil.in',   sections: ['sec_basic'] },
    { id: 'u7',  name: 'Fresh Group I/C',    rank: 'AVR',    role: 'group_incharge_fresh',     designation: 'Fresh Group Incharge',    email: 'fg.ic@navy.mil.in',   sections: ['sec_fresh', 'sec_meat'] },
